...
class ReportDefinition(models.Model):
    ...
    tenant = models.ForeignKey(
        ...
        db_column="tenant_id",
        # The FK target lives in the identity-access context; at the Django
        # level we use `swappable`-style forward references so that each
        # bounded context can be developed in isolation.
    )
