...
Accounting Engine's ledger. Before a reporting test that touches
posted financial data can be considered valid, the Accounting Engine's
...
The gate is invoked by the pytest plugin (see ``conftest.py``) and by
the CI pipeline before running the reporting acceptance suite.
"""
