...
from ..models import Practice, PracticeMembership, ClientEngagement, AdvisorAccessGrant, Tenant
...
class PracticeService:
    ...
    def _send_practice_invitation_email(membership):
        ...
        {settings.FRONTEND_URL}/accept-practice-invitation/{membership.invitation_token}
    ...
    @staticmethod
    @transaction.atomic
    def grant_advisor_access(engagement, practice_user, tenant_role, granted_by,
                             scoped_entity=None, expires_at=None, reason=''):
        """
        ...
        Args:
            ...
            tenant_role: Role within client tenant
