...
from apps.document_intelligence.models import AccountingMapping, MappingSuggestion
...
class TestBRDI007_ExplicitMappings(TestCase):
    ...
    def test_historical_mapping_suggester_uses_stored_mappings(self, tenant_id):
        ...
        from apps.document_intelligence.services.suggestion import HistoricalMappingSuggester
