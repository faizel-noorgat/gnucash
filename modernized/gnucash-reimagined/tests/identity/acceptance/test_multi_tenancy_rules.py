...
from apps.identity.models import User, Tenant, Membership
from apps.identity.services.authorization import AuthorizationService
from common.middleware.tenant import TenantContext, get_current_tenant_id
...
class TestPracticeAccessRules(TestCase):
    ...
    def test_practice_access_requires_explicit_client_engagement(self):
        ...
        """
        from apps.identity.models import Practice, PracticeMembership, ClientEngagement
