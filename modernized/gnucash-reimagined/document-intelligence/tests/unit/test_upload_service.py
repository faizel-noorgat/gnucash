...
from document_intelligence.providers.storage import MockObjectStorageClient
from document_intelligence.services.upload import UploadService
...
class TestUploadService(TestCase):
    ...
    def setUp(self):
        self.storage_client = MockObjectStorageClient()
