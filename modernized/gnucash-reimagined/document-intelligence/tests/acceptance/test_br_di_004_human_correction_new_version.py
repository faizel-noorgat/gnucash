...
from document_intelligence.services.extraction import ExtractionService
...
class TestBRDI004_HumanCorrectionCreatesNewVersion(TestCase):
    ...
    def test_human_correction_creates_new_version(self, sample_document, user_id):
        ...
        from document_intelligence.providers.ocr import get_ocr_provider
        from document_intelligence.providers.extraction import get_extraction_engine
        from document_intelligence.providers.ai import get_ai_suggester
