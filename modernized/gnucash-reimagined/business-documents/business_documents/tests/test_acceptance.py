...
from business_documents.tests.factories import (
...
class TestBR_BUS_001_InvoicePostingIsOneWay(TestCase):
    ...
    def test_posting_creates_journal_entry(self):
        ...
        # Note: This test will be marked as expected failure until accounting engine is implemented
        pytest.xfail("Accounting engine not yet implemented")
...
class TestBRTAX003_DiscountOrderingModes(TestCase):
    ...
    def test_pretax_discount_mode(self):
        ...
        from business_documents.models.line import DiscountOrderingMode
