...
(``identity-access/identity_access/domain/services/notification_service.py``),
...
from apps.identity.models import Notification, NotificationPreference
...
class NotificationService:
    ...
    def _queue_notification_delivery(notification):
        ...
        """
        # Delivery is still handled synchronously in v1; this is the seam where
        # an async delivery task will be dispatched once the identity app grows
        # a tasks module. The round-one service was likewise a no-op here.
    ...
    def send_email_notification(notification):
        ...
        Raises:
            Exception: Re-raised after recording a ``failed`` email status.
        """
